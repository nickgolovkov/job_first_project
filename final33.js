...
var top_show = 150; // В каком положении полосы прокрутки начинать показ кнопки "Наверх"
  ...
  $('#header-text-box-1').click(function () { // При клике по кнопке "Наверх" попадаем в эту функцию
      /* Плавная прокрутка наверх */
      $('body, html').animate({
        scrollTop:75
      }, delay);
  ...
  $('#header-text-box-2').click(function () { // При клике по кнопке "Наверх" попадаем в эту функцию
      /* Плавная прокрутка наверх */
      $('body, html').animate({
        scrollTop:656
      }, delay);
...
$('#header-text-box-3').click(function () { // При клике по кнопке "Наверх" попадаем в эту функцию
      /* Плавная прокрутка наверх */
      $('body, html').animate({
        scrollTop:1343
      }, delay);
...
$('#header-text-box-5').click(function () { // При клике по кнопке "Наверх" попадаем в эту функцию
      /* Плавная прокрутка наверх */
      $('body, html').animate({
        scrollTop:2405
      }, delay);
...
$('#header-text-box-4').click(function () { // При клике по кнопке "Наверх" попадаем в эту функцию
      /* Плавная прокрутка наверх */
      $('body, html').animate({
        scrollTop:1928
      }, delay);
...
$('#header-text-box-6').click(function () { // При клике по кнопке "Наверх" попадаем в эту функцию
      /* Плавная прокрутка наверх */
      $('body, html').animate({
        scrollTop:4590
      }, delay);
...
$('#slide-menu-1').click(function () { // При клике по кнопке "Наверх" попадаем в эту функцию
      /* Плавная прокрутка наверх */
      $('body, html').animate({
        scrollTop:0
      }, delay);
...
$('#slide-menu-1').click(function () { // При клике по кнопке "Наверх" попадаем в эту функцию
      /* Плавная прокрутка наверх */
   setTimeout(function(){$('#my-menu').css('opacity','0');},600)
  setTimeout(function(){
      $('body, html').animate({
        scrollTop:0
      }, delay);
...
$('#slide-menu-2').click(function () { // При клике по кнопке "Наверх" попадаем в эту функцию
      /* Плавная прокрутка наверх */
       setTimeout(function(){$('#my-menu').css('opacity','0');},600)
  setTimeout(function(){
      $('body, html').animate({
...
$('#slide-menu-3').click(function () { // При клике по кнопке "Наверх" попадаем в эту функцию
      /* Плавная прокрутка наверх */
  setTimeout(function(){$('#my-menu').css('opacity','0');},600)
  setTimeout(function(){
      $('body, html').animate({
...
$('#slide-menu-4').click(function () { // При клике по кнопке "Наверх" попадаем в эту функцию
      /* Плавная прокрутка наверх */
      setTimeout(function(){$('#my-menu').css('opacity','0');},600)
  setTimeout(function(){
      $('body, html').animate({
...
$('#slide-menu-5').click(function () { // При клике по кнопке "Наверх" попадаем в эту функцию
      /* Плавная прокрутка наверх */
       setTimeout(function(){$('#my-menu').css('opacity','0');},600)
  setTimeout(function(){
      $('body, html').animate({
...
$('#slide-menu-6').click(function () { // При клике по кнопке "Наверх" попадаем в эту функцию
      /* Плавная прокрутка наверх */
       setTimeout(function(){$('#my-menu').css('opacity','0');},600)
  setTimeout(function(){
      $('body, html').animate({
...
$('#slide-small-but-id-4').on('click',function(){
  ...
  $('#slide-small-but-id-4').fadeOut(700,function(){
    ...
    $('.slide-button-44').css('margin-top','0%');
...
var clicked_small_but11 = true;
$('#slide-small-but-id-44').on('click',function(){
  if(clicked_small_but11){
  $('.slide-button-44').fadeOut(700);
  $('#slide-small-but-id-44').fadeOut(700,function(){
    $('#slide-small-but-id-44').html('Печать на самоклеющейся<br>пленке. Печать на<br>самоклеющейся пленке с<br>ламинацией. Печать на <br>самоклеющейся пленке с<br>плоттерной вырубкой. Печать<br>на пленке с перфорацией.<br>Печать на баннере. Печать на<br>баннере с перфорацией.<br> Печать на текстиле. Печать на<br>бумаге большого формата.<br>Установка люверсов для<br>крепления');
    $('.mobile-all-content').find('.slide-small-but-id-44').css('margin-top','0%');
    $('.mobile-all-content').find('.slide-button-44').css('margin-top','4%');
  $('#slide-small-but-id-44').css('text-align','center');
  $('#slide-small-but-id-44').css('font-size','11pt');
    $('.mobile-all-content').find('#slide-small-but-id-44').css('font-size','180%');
  $('#slide-small-but-id-44').css('line-height','1.5');
  $('#slide-small-but-id-44').css('margin-bottom','8px');
  $('#slide-small-but-id-44').css('color','#f6e032');
     $('#slide-small-but-id-44').fadeIn(700);
  });
  $('#slide-header-id-44').fadeOut(700,function(){
    $('#slide-header-id-44').css('font-size','11pt');
    $('.mobile-all-content').find('#slide-header-id-44').css('font-size','300%');
  $('#slide-header-id-44').text('ШИРОКОФОРМАТНАЯ ПЕЧАТЬ');
    $('.slide-button-44').css('bottom','-13px');
    $('.slide-button-44').fadeIn(700);
    $('#slide-header-id-44').fadeIn(700);
  });
  $('#slide-image-id-44').fadeOut(700);
   $('#slide-small-text-2-id-44').fadeOut(700);
  }
  clicked_small_but11 = false;
})

var clicked_small_but22 = true;
$('#slide-small-but-id-11').on('click',function(){
  if(clicked_small_but22){
  $('.slide-button').fadeOut(700);
  $('#slide-small-but-id-11').fadeOut(700,function(){
    $('#slide-small-but-id-11').html('Таблички, указатели<br>Плоские вывески<br>Объемные вывески<br>Живую рекламу<br>Световые короба<br>Объемные буквы<br>Объемные световые буквы<br>Крышные конструкции<br>Консоли<br>Баннера (растяжки)');
  $('#slide-small-but-id-11').css('text-align','center');
  $('#slide-small-but-id-11').css('font-size','11pt');
    $('.mobile-all-content').find('#slide-small-but-id-11').css('font-size','180%');
  $('#slide-small-but-id-11').css('line-height','1.5');
  $('#slide-small-but-id-11').css('color','#f6e032');
     $('#slide-small-but-id-11').fadeIn(700);
  });
  $('#slide-header-id-11').fadeOut(700,function(){
    $('#slide-header-id-11').css('font-size','11pt');
    $('.mobile-all-content').find('#slide-header-id-11').css('font-size','300%');
  $('#slide-header-id-11').text('НАРУЖНАЯ РЕКЛАМА');
    $('#slide-header-id-11').fadeIn(700);
  });
  $('#slide-image-id-11').fadeOut(700);
   $('#slide-small-text-2-id-11').fadeOut(700,function(){
    $('#slide-small-text-2-id-11').html('Согласование наружной рекламы<br>изготовление паспорта рекламы)');
    $('#slide-small-text-2-id-11').css('font-size','10pt');
     $('.mobile-all-content').find('#slide-small-text-2-id-11').css('font-size','200%');
    $('#slide-small-text-2-id-11').css('color','#929292');
     $('#slide-small-text-2-id-11').css('margin-top','23px');
     $('.slide-button').css('bottom','-30px');
     $('.slide-button').fadeIn(700);
    $('#slide-small-text-2-id-11').fadeIn(700);
  }); 
  }
  clicked_small_but22 = false;
})


var clicked_small_but3 = true;
$('#slide-small-but-id-22').on('click',function(){
  if(clicked_small_but33){
  $('.slide-button-blue').fadeOut(700);
  $('#slide-small-but-id-22').fadeOut(700,function(){
    $('#slide-small-but-id-22').html('Гарантия на систему- 1 год.<br>Срочное изготовление и поставка по<br>индивидуальному заказу.<br>Сложные формы. Подбор<br>оптимального исполнения исходя<br>из конкретного заказа.<br>Разработка индивидуального<br>дизайна. Доставка и монтаж<br>Необычные цвета- от ртутного<br>до жемчужного и голограмного.');
  $('#slide-small-but-id-22').css('text-align','center');
  $('#slide-small-but-id-22').css('font-size','11pt');
    $('.mobile-all-content').find('#slide-small-but-id-22').css('font-size','180%');
  $('#slide-small-but-id-22').css('line-height','1.5');
  $('#slide-small-but-id-22').css('color','#fff');
     $('#slide-small-but-id-22').fadeIn(700);
  });
  $('#slide-header-id-22').fadeOut(700,function(){
    $('#slide-header-id-22').css('font-size','11pt');
    $('.mobile-all-content').find('#slide-header-id-22').css('font-size','300%');
  $('#slide-header-id-22').text('НАРУЖНАЯ РЕКЛАМА');
    $('#slide-header-id-22').fadeIn(700);
  });
  $('#slide-image-id-22').fadeOut(700,function(){
    $('#slide-image-id-22').find('img').attr('src','https://image.ibb.co/mCSd47/image.png');
    $('#slide-image-id-22').css('margin-top','25px');
        $('.slide-button-blue').css('bottom','-10px');
$('.slide-button-blue').fadeIn(700);
    $('#slide-image-id-22').fadeIn(700);
});
   $('#slide-small-text-2-id-22').fadeOut(700); 
}
  clicked_small_but33=false;
})


var clicked_small_but44 = true;
$('#slide-small-but-id-33').on('click',function(){
  if(clicked_small_but44){
  $('.slide-button-pink').fadeOut(700);
  $('#slide-small-but-id-33').fadeOut(700,function(){
    $('#slide-small-but-id-33').html('Ксерокопия<br>Контрольные работы<br>Афиши<br>Плакаты<br>Визитки<br>Грамоты<br>Благодарности<br>Пригласительные<br>Открытки');
  $('#slide-small-but-id-33').css('text-align','center');
  $('#slide-small-but-id-33').css('font-size','11pt');
    $('.mobile-all-content').find('#slide-small-but-id-33').css('font-size','180%');
  $('#slide-small-but-id-33').css('line-height','1.5');
  $('#slide-small-but-id-33').css('color','#fff');
     $('#slide-small-but-id-33').fadeIn(700);
  });
  $('#slide-header-id-33').fadeOut(700,function(){
    $('#slide-header-id-33').css('font-size','11pt');
    $('.mobile-all-content').find('#slide-header-id-33').css('font-size','300%');
  $('#slide-header-id-33').text('НАРУЖНАЯ РЕКЛАМА');
    $('#slide-header-id-33').fadeIn(700);
  });
  $('#slide-image-id-33').fadeOut(700);
   $('#slide-small-text-2-id-33').fadeOut(700,function(){
    $('#slide-small-text-2-id-33').html('На нашем Японском оборудовании<br>изготовим печатную продукцию в<br>кратчайшие сроки. Услуги<br>дизайнера');
    $('#slide-small-text-2-id-33').css('font-size','10pt');
     $('.mobile-all-content').find('#slide-small-text-2-id-33').css('font-size','180%');
    $('#slide-small-text-2-id-33').css('color','#ccb9c2');
     $('#slide-small-text-2-id-33').css('margin-top','23px');
     $('.slide-button-pink').css('bottom','-23px');
     $('.slide-button-pink').fadeIn(700);
      //$('.slide-button-pink').css('bottom','-23px');
    $('#slide-small-text-2-id-33').fadeIn(700);
  }); 
  }
  clicked_small_but44=false;
})
...
var bigHeaders=['СРОЧНАЯ ПЕЧАТЬ','ИНТЕРЬЕРНАЯ ПЕЧАТЬ','НАРУЖНАЯ РЕКЛАМА','ШИРОКО-<br>ФОРМАТНАЯ ПЕЧАТЬ'];
...
function chengeText() {
   $('#mobile-text-big-last').fadeOut(700,function(){
     $('.mob-big-text-header-text').html(bigHeaders[countertext]);
