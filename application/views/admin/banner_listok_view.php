...
<div style="float: left;margin-left: 10px;width: 290px;height: 70px;" class="alert ng-isolate-scope alert-success alert-dismissable" role="alert"  type="success" >
    <button class="close del_banner" name="<?=$item['id'];?>" type="button" >
        <span aria-hidden="true">×</span>
        <span class="sr-only">Close</span>
    </button>
    <div class="material_<?=$item['id'];?>" ng-transclude="">
        <span class="ng-binding ng-scope"><a href="<?=base_url();?>administration/edit_banner/<?=$item['id'];?>"><?=$item['alt_text'];?></a></span>
    </div>
</div>
<?php endforeach;?>
